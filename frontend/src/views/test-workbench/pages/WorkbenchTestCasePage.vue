<template>
  <section class="workbench-list-section">
    <WorkbenchPageHeader title="用例管理" />
    <WorkbenchContentCard><WorkbenchAssetListPage asset-type="test_case" /></WorkbenchContentCard>
  </section>
</template>

<script setup>
import WorkbenchAssetListPage from '@/views/test-workbench/components/WorkbenchAssetListPage.vue'
